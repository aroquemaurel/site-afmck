...
<div class="container-fluid">
    ...
    <p>
        Avant de pouvoir demander à adhérer à l'Association Française McKenzie, vous devez tout d'abord vérifier que vous respecter les critères.
    </p><p>
    ...
    <p>
        Une fois que vous avez validé le formulaire vous allez recevoir un e-mail à l'adresse que vous avez fourni.
        Cet email doit arriver assez rapidement dans votre boite, si tel n'est pas le cas, vérifiez votre dossier de spam.
    </p>

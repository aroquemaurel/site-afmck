...
<div class="container-fluid">
    ...
    <p>Voici quelques propositions de fiches de synthèse destinées à être envoyées aux médecins prescripteurs.<br />
        Vous pourrez ouvrir ces fiches (.dot) en utilisant Word.
    ...
    <div class=bs-callout bs-callout-info">48ème Salon Mondial de la Rééducation Parc Floral de Paris 12 octobre 2012</div>
    ...
    <a href="<?php echo Visitor::getInstance()->getRootPage()."/docs/members/com/";?>/confjacky/Lombalgie et MDT- INK 13 10 2012_AFMcK.pdf">
        <img src="../pgadh/<?php echo Visitor::getInstance()->getRootPage()."/docs/members/com/";?>/confjacky/Lombalgie et MDT- INK 13 10 2012_AFMcK.jpg">
            ...
            <p>Cliquez sur le lien ci dessus afin d'ouvrir le document pdf, puis lancez le player audio.</p>
            </div>
        </div>

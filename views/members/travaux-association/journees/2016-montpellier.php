...
<div class="container-fluid">
    <h1>5èmes Journées de l'AFMcK — Montpellier 2016</h1>
</div><!--/.well -->
    ...
    <a href="<?php echo Visitor::getInstance()->getRootPage() ?>/docs/members/afmckday/montpellier/2016_montpellier.pdf" target="_blank">
        <img src="<?php echo Visitor::getInstance()->getRootPage() ?>/docs/members/afmckday/montpellier/Montpellier2016_cover.jpg" width="450" alt="img presentation " />
    </a>
    </div>
